...
| `WalletDepositTool` | Verify an on-chain treasury transfer and credit the OpenJobs ledger |
...
matching treasury ATA, run `WalletDepositTool` with the Solana transaction
